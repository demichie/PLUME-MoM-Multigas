...
with open("input_file_template_inversion.py", "r") as f1, open("sample_locations", "r") as f2, open("parameters_range_inversion.py", "r") as f3, open("input_file.py", "wa") as f4:
	...
	samples=f2.read()
	f2.close()
	plumeheight_a=f3.readline()
	plumeheight_b=f3.readline()
	water_mass_fraction_a=f3.readline()
	water_mass_fraction_b=f3.readline()
	shapefactor_a=f3.readline()
	shapefactor_b=f3.readline()
	f3.close()
	plumeheight_a=str(re.findall("\d+\.\d+", plumeheight_a))
	plumeheight_a=plumeheight_a[2:-2]
	plumeheight_a=float(plumeheight_a)
	plumeheight_b=str(re.findall("\d+\.\d+", plumeheight_b))
	plumeheight_b=plumeheight_b[2:-2]
	plumeheight_b=float(plumeheight_b)
	...
	f4.write(line22)
	f4.write(line23)
	f4.write('plume_height = ['), f4.write(str(round(uniform(plumeheight_a, plumeheight_MFR_b), 4))), f4.write(']')
	f4.write('\n')
	f4.write(line25)
	f4.write(line26)
	f4.write(line27)
