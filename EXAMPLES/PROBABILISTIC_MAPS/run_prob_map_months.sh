...
par=$(python parameters_range_Probmap.py iterations "iterations with spaces")
a=$(($par / 12))
...
do
	...
	python sample_emittimes_Jan_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Feb_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Mar_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Apr_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_May_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Jun_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Jul_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Aug_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Sep_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Oct_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Nov_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
...
do
	...
	d=$(grep -i 'plumeheight_flag' parameters_range_Probmap.py |cut -c 20)
	python sample_duration.py
	python sample_emittimes_Dec_$b.py
	python sample_mfr_$c.py
	python sample_TGSD_sk_kur.py
	python inputfile_generator_Probmap_$d.py
