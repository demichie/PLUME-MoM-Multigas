...
if a.shape[0] == 0 :
    ...
    for i in range(npart):
            ...
            # The values between half_conc and max_conc are plotted
            # with a linear scale. The values smaller than half_conc
            ...
            f.savefig(runname+'_'+'CL'+str(i+1)+'_'+day+'_'+time+'.pdf', bbox_inches='tight')
